...
<div class="modal fade" id="stockpost-modal" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false"
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content" style="border-radius: 10px;">
			...
			<div class="modal-footer">
				<button onclick="location.href='<?php echo base_url("post_counted"); ?>'" type="button" class="btn btn-secondary pull-left">
					<i
							class="far fa-exclamation-circle"></i>&nbsp;&nbsp; NO
				</button>
				<button onclick="location.href='<?php echo base_url("post_stocks"); ?>'" type="button" class="btn btn-success"><i
