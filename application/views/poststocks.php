                    ...
                    <div class="box-footer">
                        ...
                        if ($tempsheets_status == 0) { ?>
                            <?php if ($stocktakestatus == 1 && $pendingsyncrecords == 0) { ?>
                                ...
                                <button class="btn btn-flat btn-danger" style="border-radius: 5px;" data-target="#stockpost-modal" data-toggle="modal">
                                    <i class="far fa-hdd"></i>&nbsp;&nbsp;&nbsp;Post Stock Take.</button>
                            <?php } elseif ($stocktakestatus == 0 && $pendingsyncrecords == 0) { ?>
                                <button type="button" class="btn btn-info btn-flat" style="border-radius: 5px;" disabled><i class="far fa-times-circle"></i>&nbsp;No active stake.</button>
                            <?php } elseif ($stocktakestatus == 1 && $pendingsyncrecords != 0) { ?>
                                <button type="button" class="btn btn-info btn-flat" style="border-radius: 5px;" disabled><i class="far fa-times-circle"></i>&nbsp;Synch pending sheets to continue.</button>
                            <?php } ?>
                        <?php } else { ?>
                            <button type="button" class="btn btn-info btn-flat" style="border-radius: 5px;" disabled><i class="far fa-times-circle"></i>&nbsp;Save Pending sheets to continue.</button>
                        <?php } ?>
                    </div><!-- /.box -->
                </div><!-- /.box-body -->
            </div><!-- /.box -->
...
<div class="modal modal-default" id="stockpost-modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-sm">
        <div class="modal-content" style="border-radius: 10px;">
            ...
            <div class="modal-footer">
                <button onclick="location.href='<?php echo base_url(); ?>post_counted'" type="button" class="btn pull-left"><i class="far fa-exclamation-circle"></i>&nbsp;&nbsp; NO</button>
                <button onclick="location.href='<?php echo base_url(); ?>post_stocks'" type="button" class="btn"><i class="fal fa-check-circle"></i>&nbsp; YES</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
