...
<div class="login-box">
    <div class="login-logo">
        <a class="text-decoration-none" href="<?php echo base_url(); ?>"><b>STOCK</b>Take</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <img src="<?php echo base_url(); ?>assets/theme/img/pixel_weave.png" style="width:60px; height:60px; display:block; margin: 0 auto;"
             class="user-image rounded-circle" alt="User Image"/><br>
