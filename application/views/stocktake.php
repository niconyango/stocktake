            ...
            <div class="col-md-4">
                <div class="box box-danger">
                        ...
                        <form role="form" id="stock-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    <input type="text" name="reasoncode" id="reasoncode" value="<?php echo $reason; ?>" autocomplete="off" class="form-control" readonly required />
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    <input type="text" name="bin" id="bin" value="<?php echo $shelf; ?>" autocomplete="off" class="form-control" required />
                                    <div class="input-group-addon">
                                        <i></i>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    <input type="text" name="item_code" id="item_code" autocomplete="off" class="form-control" placeholder="Code" required />
                                    <div class="input-group-addon">
                                        <i></i>
                                    </div>
                                </div><!-- /.input group -->
                    ...
                    <!-- <div class="modal-footer justify-content-between">
                        <button onclick="location.href='<?php echo base_url(); ?>sync_stocks'" type="button" class="btn btn-success btn-flat" data-dismiss="modal" style="float:left"><i class="fas fa-sync-alt"></i>&nbsp;Sync Sheets</button>
                    </div> -->
                </div><!-- /.box -->
            </div><!-- /.col (left) -->
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <button onclick="location.href='<?php echo base_url(); ?>post_sheets'" type="button" data-backdrop="static" class="btn btn-primary btn-flat pull-right" style="border-radius: 5px;"><i class="fad fa-file-upload"></i>&nbsp; Save Sheet</button>
                    </div>
                    <div class="box-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><button class="btn btn-xs btn-warning btn-edit" id="<?php echo $row->ID; ?>" itemid="<?php echo $row->ItemID; ?>" itemcode="<?php echo $row->ItemLookupCode; ?>" description="<?php echo $row->Itemdescription; ?>" shelf="<?php echo $row->Shelf; ?>" quantity="<?php echo $row->Quantity; ?>" cashier="<?php echo $row->CashierName; ?>"><i class="fal fa-edit"></i>&nbsp;Edit</button>
                                                <a class="btn btn-xs btn-danger" href="<?php echo base_url() ?>remove/<?php echo $row->ID; ?>"><i class="far fa-trash"></i>&nbsp;Remove</a>
                                            </td>
                                        </tr>
                                <?php
                                        // $i++;
...
<div class="modal modal-default" id="codeupdate-modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-warning modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button onclick="location.href='<?php echo base_url(); ?>cancelcode'" class="btn btn-flat btn btn-outline pull-left"><i class="far fa-times-circle"></i>&nbsp;&nbsp; Cancel</button>

                <button onclick="location.href='<?php echo base_url(); ?>updatecode'" type="button" class="btn btn-flat btn btn-outline"><i class="far fa-check-circle"></i>&nbsp; Add</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
<div class="modal modal-default" id="bin-modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel">
...
<div class="modal modal-default" id="entries-modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-warning modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> -->
