                                    ...
                                    <form role="form" action="<?php echo base_url() ?>customsearch" method="post">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-1">
                                                <button type="submit" style="border-radius: 5px;" class="btn btn-success btn-flat btn-search"><i class="fas fa-search"></i>&nbsp;&nbsp; Search</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <table id="stock" class="table table-bordered table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo number_format($tvalue, 2); ?></th>
