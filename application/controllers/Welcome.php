...
class Welcome extends CI_Controller
{
	...
	public function customsearch()
	{
		if ($this->session->userdata('logged')) {
			...
			$data['categories'] = $this->Stocktake->category();
			$data['subcategories'] = $this->Stocktake->subcategory();
			$data['skus'] = $this->Stocktake->customised_holdings($DepartmentID, $CategoryID, $SubCategoryID);
			/** Header title */
			$data['title'] = 'Current Stocks';
	...
	public function stocks()
	{
		if ($this->session->userdata('logged')) {
			...
			$data['categories'] = $this->Stocktake->category();
			$data['subcategories'] = $this->Stocktake->subcategory();
			$data['products'] = $this->Stocktake->stocks();
			/** Header title */
	...
	/** Specific department/category/subcategory */
	public function specific_category()
	{
		if ($this->session->userdata('logged')) {
			...
			$data['categories'] = $this->Stocktake->category();
			$data['subcategories'] = $this->Stocktake->subcategory();
			$data['products'] = $this->Stocktake->counted_stocks($DepartmentID, $CategoryID, $SubCategoryID);
			/** Header title */
			$data['title'] = 'Stock Take';
	...
	/** Uncounted stocks report */
	public function uncounted_category()
	{
		if ($this->session->userdata('logged')) {
			...
			$data['categories'] = $this->Stocktake->category();
			$data['subcategories'] = $this->Stocktake->subcategory();
			$data['products'] = $this->Stocktake->uncounted_stocks($DepartmentID, $CategoryID, $SubCategoryID);
			/** Header title */
			$data['title'] = 'Stock Take';
