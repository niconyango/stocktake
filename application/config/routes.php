...
$route['fetch_entries'] = 'welcome/fetch_entries';
$route['fetch_stocks'] = 'welcome/fetch_stocks';
$route['fetch_holdings'] = 'welcome/fetch_holdings';
$route['fetch_uncounted'] = 'welcome/fetch_uncounted';
$route['fetch_sheets'] = 'welcome/fetch_sheets';
$route['fetch_details/(:any)'] = 'welcome/fetch_details/$1';
